...
public class PageWidget extends View {
	...
	/**  拖拽点对应页角的X  */
	public int mCornerX = 0; // 拖拽点对应的页脚
	/**  拖拽点对应页角的Y  */
	 ...
	 * 计算拖拽点对应的拖拽角
	 * 以点击的点的坐标位置判断左右翻
	 * @param x x小于width一半的时候， mCornerX = 0 否则即等于width;
	 * @param y y小于height一半的时候，mCornerY = 0 否则即等于Height;
	 */
	...
	public boolean doTouchEvent(MotionEvent event, BookPageFactory pagefactory) {
		...
		if (event.getAction() == MotionEvent.ACTION_UP) {
			...
			//当滑动方向正确，且滑动快过move拾取getX的间隔大于0.5px时候，才ready翻页动画
			if(mCornerX == 0 ){
